...
ActiveRecord::Schema.define(version: 20190131115815) do
  ...
  create_table "okiniiris", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.index ["user_id", "micropost_id"], name: "index_okiniiris_on_user_id_and_micropost_id", unique: true, using: :btree
